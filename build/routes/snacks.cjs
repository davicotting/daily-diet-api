...
function snacks(app) {
  return __async(this, null, function* () {
    ...
    app.patch("/:snack_id", (request, reply) => __async(null, null, function* () {
    ...
    app.get("/:snack_id", (request, reply) => __async(null, null, function* () {
      const requestParamsSchema = zod.object({
        snack_id: zod.string().uuid()
      });
      const { snack_id } = requestParamsSchema.parse(request.params);
    ...
    app.delete("/:snack_id", (request, reply) => __async(null, null, function* () {
      const requestParamsSchema = zod.object({
        snack_id: zod.string().uuid()
      });
      const { snack_id } = requestParamsSchema.parse(request.params);
    ...
    app.get("/analytics", (request, reply) => __async(null, null, function* () {
      const { userId } = request.cookies;
